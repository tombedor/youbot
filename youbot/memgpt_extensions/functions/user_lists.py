import os
from sqlalchemy import UUID, Column, Integer, MetaData, NullPool, String, ForeignKey, Table, UniqueConstraint, create_engine
...
LIST_ITEMS = Table('list_items', metadata,
    Column('id', Integer, primary_key=True),
