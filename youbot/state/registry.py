...
from youbot.config import AppConfig, RepoConfig, state_root
from youbot.core.models import CommandRecord, RepoRecord, RepoStatus
...
class Registry:
    ...
    def _build_repo_record(self, repo_config: RepoConfig) -> RepoRecord:
