...
from youbot.chat.openai_tools import build_tool_specs
from youbot.chat.tool_handler import ToolResult
...
class OpenAIChatOrchestrator:
    ...
    def respond(
        ...
        *,
        ...
        tool_handler: Callable[[str, dict[str, object]], ToolResult],
    ) -> tuple[str, str | None]:
