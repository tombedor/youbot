# script which can re-set functions which all agents have
# ie, when a new capability needs to be rolled out globally.
# needs to be updated to account for how agents are stored now.
...
#     client = MemGPT(user_id=user_id, debug=True)
