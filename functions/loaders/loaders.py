...
if __name__ == "__main__":
    class Querier(object):
        pass
    setattr(Querier, 'query_github_repo_without_loading', query_github_repo_without_loading)
    Querier().query_github_repo_without_loading('cpacker', 'MemGPT', 'how is the system prompt loaded into the agent?')
